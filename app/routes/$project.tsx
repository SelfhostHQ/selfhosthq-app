...
export default function Dashboard() {
  ...
  const currentPath = project + '/' + matches[2].pathname.split('/')[2]
  const navigation = [
    { name: 'Dashboard', href: project + '/', icon: HomeIcon },
    { name: 'Apps', href: project + '/apps', icon: WindowIcon },
    { name: 'Team', href: project + '/team', icon: UsersIcon },
  ]
    ...
    <>
      <div>
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
          {/* Sidebar component, swap this element with another sidebar if you like */}
          <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-secondary px-6 pb-4">
